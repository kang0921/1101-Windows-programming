    ...
    public partial class Form2 : Form
    {
        ...
        {     
            ...
            {    //ex4：畫砲管
                ...
                double r12 = 12 * r;
                Pen DarkGrayPen = new Pen(Brushes.DarkGray);    // 宣告 + new 深藍色  畫筆
                DarkGrayPen.Width = 20.0F;   // 改變 畫筆 寬度
                g.DrawLine(DarkGrayPen,      // 深藍色  畫筆
...
　　　           else if (y < r || y > height - r) { //出上下邊
        ...
        {    //Form2 建構者：和 class(類別) 同名 的副程式，new時 被自動執行
            ...
            balls[0] = new ball(580, 700, Color.FromArgb(255, 255, 255, 255), 0);   // 0號球(母球)， 白色，放右邊中間
